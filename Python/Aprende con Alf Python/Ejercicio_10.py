...
así que deben calcular el peso de los payasos y muñecas que saldrán en cada paquete a demanda. Cada payaso pesa 112 g y cada muñeca 75 g. 
...
n_muñecas=int(input("Número de muñecas: "))
print(f"Peso total: {(payasos*n_payasos)+(muñecas*n_muñecas)} g")